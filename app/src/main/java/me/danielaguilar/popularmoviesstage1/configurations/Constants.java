...
public class Constants {
    public static final String API_KEY              = BuildConfig.API_KEY;//TODO add api_key in gradle.proprties
    public static final String API_BASE_URL         = "https://api.themoviedb.org";
    public static final String IMAGES_BASE_URL      = "http://image.tmdb.org/t/p/w342";//"http://image.tmdb.org/t/p/w185";
